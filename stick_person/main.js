...
var positionStateStore = {
  ...
  HEEL_DOWN_CALF_STRETCH_RIGHT_DEEPER: {
    speed: 2000,
    coords: [
      {
        "ref": "headCircle",
  ...
  TOUCH_TOES_RIGHT_FULL_STRETCH_EASY: {
    speed: 2000,
    coords: [
      {
        "ref": "headCircle",
  ...
  TOUCH_TOES_STRAIGHT_EASY_STRETCH: {
    speed: 5000,
    coords: [
      {
        "ref": "headCircle",
  ...
  TOUCH_TOES_STRAIGHT_EASY_START: {
    speed: 2000,
    coords: [
      {
        "ref": "headCircle",
