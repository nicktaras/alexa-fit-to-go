...
const exerciseStore = {
  ...
  'LEG_RAISES': {
    ...
    config: {
      ...
      repeatedInstruction: 'Slowly lift you are leg off the floor until your thigh is parellel to the ground. Hold for one, two, three, seconds. Then bring it down to the floor. Then ',
      finalInstruction: 'Let us do this one last time. Slowly lift your leg off the floor until your thigh is parellel to the ground. Hold for one, two, three, seconds. Then bring it down to the floor. ',
      congratulate: true
    }    
  },
